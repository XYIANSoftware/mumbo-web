...
export function SocialLinksEditor() {
	...
	const iconForPlatform = (platform: string): string => {
		if (platform in platformToIcon) {
			return platformToIcon[platform as keyof typeof platformToIcon]
		}
		return platformToIcon.INSTAGRAM
	}
	...
	const emptyItem = (): SocialLink => ({
		...
		platform: 'INSTAGRAM',
		url: '',
		icon: iconForPlatform('INSTAGRAM'),
		username: '',
